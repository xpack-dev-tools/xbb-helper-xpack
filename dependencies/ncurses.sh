    ...
    (
      ...
      then
        (
          ...
          # Running sh /home/ilg/Work/xpacks/qemu-arm-xpack.git/build/linux-x64/sources/ncurses-6.3/misc/shlib tic to install /etc/terminfo:/lib/terminfo:/usr/share/terminfo ...
