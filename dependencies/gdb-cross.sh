...
function gdb_cross_build()
{
  ...
  then
    ...
    (
      ...
      # config_options+=("--with-libexpat-type=static") # AArch64 (why static?)
      ...
      # config_options+=("--with-libgmp-type=static") # AArch64 (why static?)
      ...
      # config_options+=("--with-libmpfr-type=static") # AArch64 (why static?)
