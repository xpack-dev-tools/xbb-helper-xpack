...
function test_gcc()
{
  ...
  (
    ...
    run_app_verbose "${test_bin_path}/gcov" --version
    run_app_verbose "${test_bin_path}/gcov-dump" --version
    run_app_verbose "${test_bin_path}/gcov-tool" --version
    ...
    (
      ...
      then
        ...
        run_app_verbose "${CC}" -o add.o -c add.c -fpic -ffunction-sections -fdata-sections
      fi
      ...
      run_app_verbose "${CC}" ${VERBOSE_FLAG} -o static-adder${XBB_HOST_DOT_EXE} adder.c -ladd-static -L . -ffunction-sections -fdata-sections ${GC_SECTION}
      ...
      then
        ...
        run_app_verbose "${CC}" ${VERBOSE_FLAG} -o libadd-shared.dll -shared -Wl,--out-implib,libadd-shared.dll.a add.o -Wl,--subsystem,windows
        # -ladd-shared is in fact libadd-shared.dll.a
        # The library does not show as DLL, it is loaded dynamically.
        run_app_verbose "${CC}" ${VERBOSE_FLAG} -o shared-adder${XBB_HOST_DOT_EXE} adder.c -ladd-shared -L . -ffunction-sections -fdata-sections ${GC_SECTION}
        test_expect "42" "shared-adder" 40 2
      else
        run_app_verbose "${CC}" -o libadd-shared.${XBB_HOST_SHLIB_EXT} add.o -shared
        run_app_verbose "${CC}" ${VERBOSE_FLAG} -o shared-adder adder.c -ladd-shared -L . -ffunction-sections -fdata-sections ${GC_SECTION}
        (
...
function test_gcc_one()
{
  ...
  (
    ...
    run_app_verbose "${CC}" ${CFLAGS} -v -o ${prefix}simple-hello-c1${suffix}${XBB_HOST_DOT_EXE} simple-hello.c ${STATIC_LIBGCC}
    test_expect "Hello" "${prefix}simple-hello-c1${suffix}"

    # Test C compile and link in a single step with gc.
    run_app_verbose "${CC}" ${CFLAGS} ${VERBOSE_FLAG} -o ${prefix}gc-simple-hello-c1${suffix}${XBB_HOST_DOT_EXE} simple-hello.c -ffunction-sections -fdata-sections ${GC_SECTION} ${STATIC_LIBGCC}
    test_expect "Hello" "${prefix}gc-simple-hello-c1${suffix}"

    # Test C compile and link in separate steps.
    run_app_verbose "${CC}" ${CFLAGS} -o simple-hello-c.o -c simple-hello.c -ffunction-sections -fdata-sections
    run_app_verbose "${CC}" ${CFLAGS} ${VERBOSE_FLAG} -o ${prefix}simple-hello-c2${suffix}${XBB_HOST_DOT_EXE} simple-hello-c.o ${GC_SECTION} ${STATIC_LIBGCC}
    test_expect "Hello" "${prefix}simple-hello-c2${suffix}"

    # Test LTO C compile and link in a single step.
    run_app_verbose "${CC}" ${CFLAGS} ${VERBOSE_FLAG} -o ${prefix}lto-simple-hello-c1${suffix}${XBB_HOST_DOT_EXE} simple-hello.c -ffunction-sections -fdata-sections ${GC_SECTION} -flto ${STATIC_LIBGCC}
    test_expect "Hello" "${prefix}lto-simple-hello-c1${suffix}"

    # Test LTO C compile and link in separate steps.
    run_app_verbose "${CC}" ${CFLAGS} -o lto-simple-hello-c.o -c simple-hello.c -ffunction-sections -fdata-sections -flto
    run_app_verbose "${CC}" ${CFLAGS} ${VERBOSE_FLAG} -o ${prefix}lto-simple-hello-c2${suffix}${XBB_HOST_DOT_EXE} lto-simple-hello-c.o -ffunction-sections -fdata-sections ${GC_SECTION} -flto ${STATIC_LIBGCC}
    test_expect "Hello" "${prefix}lto-simple-hello-c2${suffix}"

    # ---------------------------------------------------------------------------

    # Test C++ compile and link in a single step.
    run_app_verbose "${CXX}" ${CXXFLAGS} -v -o ${prefix}simple-hello-cpp1${suffix}${XBB_HOST_DOT_EXE} simple-hello.cpp -ffunction-sections -fdata-sections ${GC_SECTION} ${STATIC_LIBGCC} ${STATIC_LIBSTD}
    test_expect "Hello" "${prefix}simple-hello-cpp1${suffix}"

    # Test C++ compile and link in separate steps.
    run_app_verbose "${CXX}" ${CXXFLAGS} -o simple-hello-cpp.o -c simple-hello.cpp -ffunction-sections -fdata-sections
    run_app_verbose "${CXX}" ${CXXFLAGS} ${VERBOSE_FLAG} -o ${prefix}simple-hello-cpp2${suffix}${XBB_HOST_DOT_EXE} simple-hello-cpp.o -ffunction-sections -fdata-sections ${GC_SECTION} ${STATIC_LIBGCC} ${STATIC_LIBSTD}
    test_expect "Hello" "${prefix}simple-hello-cpp2${suffix}"

    # Test LTO C++ compile and link in a single step.
    run_app_verbose "${CXX}" ${CXXFLAGS} ${VERBOSE_FLAG} -o ${prefix}lto-simple-hello-cpp1${suffix}${XBB_HOST_DOT_EXE} simple-hello.cpp -ffunction-sections -fdata-sections ${GC_SECTION} -flto ${STATIC_LIBGCC} ${STATIC_LIBSTD}
    test_expect "Hello" "${prefix}lto-simple-hello-cpp1${suffix}"

    # Test LTO C++ compile and link in separate steps.
    run_app_verbose "${CXX}" ${CXXFLAGS} -o lto-simple-hello-cpp.o -c simple-hello.cpp -ffunction-sections -fdata-sections -flto
    run_app_verbose "${CXX}" ${CXXFLAGS} ${VERBOSE_FLAG} -o ${prefix}lto-simple-hello-cpp2${suffix}${XBB_HOST_DOT_EXE} lto-simple-hello-cpp.o -ffunction-sections -fdata-sections ${GC_SECTION} -flto ${STATIC_LIBGCC} ${STATIC_LIBSTD}
    ...
    run_app_verbose "${CXX}" ${CXXFLAGS} ${VERBOSE_FLAG} -o ${prefix}simple-str-exception${suffix}${XBB_HOST_DOT_EXE} simple-str-exception.cpp -ffunction-sections -fdata-sections ${GC_SECTION} ${STATIC_LIBGCC} ${STATIC_LIBSTD}
    test_expect "MyStringException" "${prefix}simple-str-exception${suffix}"

    run_app_verbose "${CXX}" ${CXXFLAGS} ${VERBOSE_FLAG} -o ${prefix}simple-int-exception${suffix}${XBB_HOST_DOT_EXE} simple-int-exception.cpp -ffunction-sections -fdata-sections ${GC_SECTION} ${STATIC_LIBGCC} ${STATIC_LIBSTD}
    test_expect "42" "${prefix}simple-int-exception${suffix}"

    # ---------------------------------------------------------------------------
    # Test a very simple Objective-C (a printf).

    run_app_verbose "${CC}" ${CFLAGS} ${VERBOSE_FLAG} -o ${prefix}simple-objc${suffix}${XBB_HOST_DOT_EXE} simple-objc.m -O0 ${STATIC_LIBGCC}
    ...
    then
      ...
      then
        ...
        run_app_verbose ${CXX} -o libthrowcatch-lib.${XBB_HOST_SHLIB_EXT} throwcatch-lib.cpp -shared -fpic ${VERBOSE_FLAG} ${STATIC_LIBGCC} ${STATIC_LIBSTD}
      fi

      run_app_verbose ${CXX} -o ${prefix}throwcatch-main${suffix}${XBB_HOST_DOT_EXE} throwcatch-main.cpp -L. -lthrowcatch-lib ${VERBOSE_FLAG} ${STATIC_LIBGCC} ${STATIC_LIBSTD}
    ...
    then
      ...
      run_app_verbose "${CC}" ${CFLAGS} -c -o ${prefix}hello-weak${suffix}.c.o hello-weak.c -flto
      run_app_verbose "${CC}" ${CFLAGS} -c -o ${prefix}hello-f-weak${suffix}.c.o hello-f-weak.c -flto
      run_app_verbose "${CC}" ${CFLAGS} -o ${prefix}hello-weak${suffix}${XBB_HOST_DOT_EXE} ${prefix}hello-weak${suffix}.c.o ${prefix}hello-f-weak${suffix}.c.o ${VERBOSE_FLAG} -lm ${STATIC_LIBGCC} -flto
      test_expect "Hello World!" ./${prefix}hello-weak${suffix}
    else
      run_app_verbose "${CC}" ${CFLAGS} -c -o ${prefix}hello-weak${suffix}.c.o hello-weak.c
      run_app_verbose "${CC}" ${CFLAGS} -c -o ${prefix}hello-f-weak${suffix}.c.o hello-f-weak.c
      run_app_verbose "${CC}" ${CFLAGS} -o ${prefix}hello-weak${suffix}${XBB_HOST_DOT_EXE} ${prefix}hello-weak${suffix}.c.o ${prefix}hello-f-weak${suffix}.c.o ${VERBOSE_FLAG} -lm ${STATIC_LIBGCC}
      test_expect "Hello World!" ./${prefix}hello-weak${suffix}
    fi
  )
  ...
  (
    ...
    then
      ...
      run_app_verbose "${F90}" ${VERBOSE_FLAG}  -o "${prefix}hello-f${suffix}${XBB_HOST_DOT_EXE}" hello.f90 ${STATIC_LIBGCC}
