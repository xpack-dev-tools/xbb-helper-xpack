...
function test_coreutils()
{
  ...
  (
    ...
    show_libs "${test_bin_folder_path}/${prefix}basename"
    show_libs "${test_bin_folder_path}/${prefix}cat"
    show_libs "${test_bin_folder_path}/${prefix}chmod"
    show_libs "${test_bin_folder_path}/${prefix}chown"
    show_libs "${test_bin_folder_path}/${prefix}cp"
    show_libs "${test_bin_folder_path}/${prefix}dirname"
    show_libs "${test_bin_folder_path}/${prefix}ln"
    show_libs "${test_bin_folder_path}/${prefix}ls"
    show_libs "${test_bin_folder_path}/${prefix}mkdir"
    show_libs "${test_bin_folder_path}/${prefix}mv"
    show_libs "${test_bin_folder_path}/${prefix}printf"
    show_libs "${test_bin_folder_path}/${prefix}realpath"
    show_libs "${test_bin_folder_path}/${prefix}rm"
    show_libs "${test_bin_folder_path}/${prefix}rmdir"
    show_libs "${test_bin_folder_path}/${prefix}sha256sum"
    show_libs "${test_bin_folder_path}/${prefix}sort"
    show_libs "${test_bin_folder_path}/${prefix}touch"
    show_libs "${test_bin_folder_path}/${prefix}tr"
    show_libs "${test_bin_folder_path}/${prefix}wc"
