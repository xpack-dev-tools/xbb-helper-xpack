...
Use the new version, suffixed by `pre`, like `2.0.1-pre`.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v2.0.1 released_
...
- `npm dist-tag add @xpack-dev-tools/xbb-helper@2.0.1 latest`
- `npm dist-tag ls @xpack-dev-tools/xbb-helper`

If necessary, unpublish previous releases:

- `npm unpublish @xpack-dev-tools/xbb-helper@2.0.1`
