...
Determine the next version (like `4.2.1`) and update the
...
Use the new version, suffixed by `pre`, like `4.2.1-pre`.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v4.2.1 released_
...
- https://github.com/xpack-dev-tools/xbb-helper-xpack/releases/tag/v4.2.1
...
```json
"@xpack-dev-tools/xbb-helper": "github:xpack-dev-tools/xbb-helper-xpack#v4.2.1"
```
