...
Determine the next version (like `3.2.1`) and update the
`package.json` file; the format is `3.2.1-pre`.
...
and fix them; assign them to a milestone (like `3.2.1`).
...
Use the new version, suffixed by `pre`, like `3.2.1-pre`.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v3.2.1 released_
...
- `npm dist-tag add @xpack-dev-tools/xbb-helper@3.2.1 latest`
- `npm dist-tag ls @xpack-dev-tools/xbb-helper`

If necessary, unpublish previous releases:

- `npm unpublish @xpack-dev-tools/xbb-helper@3.2.1`
