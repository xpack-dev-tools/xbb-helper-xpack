...
Determine the next version (like `5.1.0`) and update the
...
Use the new version, suffixed by `pre`, like `5.1.0-pre`.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v5.1.0 released_
...
- https://github.com/xpack-dev-tools/xbb-helper-xpack/releases/tag/v5.1.0
...
```json
"@xpack-dev-tools/xbb-helper": "github:xpack-dev-tools/xbb-helper-xpack#v5.1.0"
```
