...
Determine the next version (like `3.2.2`) and update the
`package.json` file; the format is `3.2.2-pre`.
...
- add a new entry like _* v3.2.2 released_
- commit with a message like _prepare v3.2.2_
...
- `npm dist-tag add @xpack-dev-tools/xbb-helper@3.2.2 latest`
- `npm dist-tag ls @xpack-dev-tools/xbb-helper`

If necessary, unpublish previous releases:

- `npm unpublish @xpack-dev-tools/xbb-helper@3.2.2`
