...
Determine the upstream version (like `1.3.0`) and eventually update the
...
and fix them; assign them to a milestone (like `1.3.0`).
...
- add a new entry like _* v1.3.0 released_
...
- `npm dist-tag add @xpack-dev-tools/xbb-helper@1.3.0 latest`
- `npm dist-tag ls @xpack-dev-tools/xbb-helper`

If necessary, unpublish previous releases:

- `npm unpublish @xpack-dev-tools/xbb-helper@1.3.0`
