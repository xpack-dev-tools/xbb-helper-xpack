...
Determine the next version (like ``5.4.0) and update the
`package.json` file; the format is `5.4.0-pre`.
...
and fix them; assign them to a milestone (like `5.4.0`).
...
Use the new version, suffixed by `pre`, like `5.4.0-pre`.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v5.4.0 released_
- commit with a message like _prepare v5.4.0_
...
- https://github.com/xpack-dev-tools/xbb-helper-xpack/releases/tag/v5.4.0
...
```json
"@xpack-dev-tools/xbb-helper": "github:xpack-dev-tools/xbb-helper-xpack#v5.4.0"
```
