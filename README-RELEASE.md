...
Determine the upstream version (like `0.10.0`) and eventually update the
...
and fix them; assign them to a milestone (like `0.10.0`).
...
- add a new entry like _* v0.10.0 released_
...
- `npm dist-tag add @xpack-dev-tools/xbb-helper@0.10.0 latest`
- `npm dist-tag ls @xpack-dev-tools/xbb-helper`

If necessary, unpublish previous releases:

- `npm unpublish @xpack-dev-tools/xbb-helper@0.10.0`
