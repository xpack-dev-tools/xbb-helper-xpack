...
Determine the upstream version (like `0.5.5`) and eventually update the
`package.json` file; the format is `0.5.5-pre`.
...
and fix them; assign them to a milestone (like `0.5.5`).
...
- add a new entry like _* v0.5.5 released_
- commit with a message like _prepare v0.5.5_
