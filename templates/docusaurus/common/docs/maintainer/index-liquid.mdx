...
```sh
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-arm64 -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
xpm run trigger-workflow-build-linux-x64 -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
xpm run trigger-workflow-build-win32-x64 -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
xpm run trigger-workflow-build-darwin-x64 -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
```
...
xpm run trigger-workflow-test-docker-linux-x64 -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
xpm run trigger-workflow-test-docker-linux-arm -C ~/Work/xpack-dev-tools/{{appLcName}}-xpack.git/build-assets
```
