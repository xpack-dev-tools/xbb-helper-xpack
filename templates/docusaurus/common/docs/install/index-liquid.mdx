...
title: How to install the xPack {{appName}} binaries
...
[![GitHub Release Date](https://img.shields.io/github/release-date/xpack-dev-tools/{{appLcName}}-xpack)](https://github.com/xpack-dev-tools/{{appLcName}}-xpack/releases/)
...
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/xpack-dev-tools/{{appLcName}}-xpack/total)
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/{{appLcName}}/${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/{{appLcName}}/${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
the <a href={`https://github.com/xpack-dev-tools/{{appLcName}}-xpack/releases/`}>GitHub Releases</a> pages.
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\{{appLcName}}\\xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>.
...
{% if isMacOSX64 %}- <code>xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-x64.tar.gz</code>{% endif %}
{% if isMacOsArm64 %}- <code>xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-arm64.tar.gz</code>{% endif %}
...
example <code>/Users/ilg/Library/xPacks/{{appLcName}}/xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>:
...
{% if isLinuxX64 %}- <code>xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}-linux-x64.tar.gz</code>{% endif %}
{% if isLinuxArm64 %}- <code>xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}-linux-arm64.tar.gz</code>{% endif %}
{% if isLinuxArm %}- <code>xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}-linux-arm.tar.gz</code>{% endif %}
...
example <code>/home/ilg/.local/xPacks/{{appLcName}}/xpack-{{appLcName}}-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/{{appLcName}}
cd ~/.local/xPacks/{{appLcName}}

tar xvf ~/Downloads/xpack-{{appLcName}}-${customField('upstreamVersion')}-${customField('xpackSubversion')}-linux-x64.tar.gz
chmod -R -w xpack-{{appLcName}}-${customField('upstreamVersion')}-${customField('xpackSubversion')}
`} </CodeBlock>
