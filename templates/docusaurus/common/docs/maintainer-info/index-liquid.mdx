...
[![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/{{ appLcName }}-xpack/latest/total.svg)](https://github.com/xpack-dev-tools/{{ appLcName }}-xpack/releases/)
  - all xPack releases [![Github All Releases](https://img.shields.io/github/downloads/xpack-dev-tools/{{ appLcName }}-xpack/total.svg)](https://github.com/xpack-dev-tools/{{ appLcName }}-xpack/releases/){% if showDeprecatedGnuMcuAnalytics == 'true' %}
