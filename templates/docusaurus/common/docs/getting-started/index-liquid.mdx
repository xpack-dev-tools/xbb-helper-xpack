...
{% if names_array.size > 1 %}cross-platform ({{ names_array | join: ", " }}){% else %}{{ names_arra | first }}{% endif %}
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/{{appLcName}}-xpack/): It helps others discover our work.
