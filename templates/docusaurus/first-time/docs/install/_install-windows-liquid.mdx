...
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\{{ appLcName }}\\${ customField('upstreamVersion') }-${ customField('xpackSubversion') }.${ customField('npmSubversion') }\\.content\\bin\\TODO.exe --version
...
<CodeBlock language="console"> {
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\{{ appLcName }}\\xpack-{{ appLcName }}-${ customField('upstreamVersion') }-${ customField('xpackSubversion') }\\bin\\TODO.exe --version
${ customField('upstreamVersion') }`
} </CodeBlock>
