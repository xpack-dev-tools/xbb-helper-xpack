...
function xbb_reset_env()
{
  ...
  XBB_ARTEFACTS_FOLDER_NAME="${XBB_ARTEFACTS_FOLDER_NAME:-artefacts}"
  XBB_ARTEFACTS_FOLDER_PATH="${XBB_TARGET_WORK_FOLDER_PATH}/${XBB_ARTEFACTS_FOLDER_NAME}"
  ...
  export XBB_ARTEFACTS_FOLDER_PATH
